...
export default async function AdminTermDetailsPage({ params }: { params: { id: string } }) {
  ...
  // Fetch the term with related data, ensuring it belongs to the admin's school
        ...
        <div className="flex flex-col justify-between gap-4 md:flex-row md:items-center">
          ...
          <div className="flex items-center gap-2">
            ...
            {termData.isCurrent ? (
              ...
              <Button variant="outline" asChild>
                <Link href={`/dashboard/admin/school-sessions/${termData.sessionId}`}>
                  <CalendarRange className="mr-2 h-4 w-4" />
                  View Session
                </Link>
              </Button>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="pt-4">
                <Button variant="outline" asChild className="w-full">
                  <Link href={`/dashboard/admin/school-sessions/${termData.sessionId}`}>View Parent Session</Link>
                </Button>
              </div>
            </CardContent>
          </Card>
